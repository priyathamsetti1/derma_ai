...
import { Users, Search, Filter, Plus, Eye, Calendar, TrendingUp, AlertCircle } from 'lucide-react';
...
const PatientDashboard: React.FC = () => {
  ...
  const filteredPatients = patients.filter(patient => {
    ...
    const matchesFilter = selectedFilter === 'all' || 
                         patient.riskLevel.toLowerCase() === selectedFilter;
  ...
  const getStatusColor = (status: string) => {
    if (status.includes('Active')) return 'text-blue-600 bg-blue-50';
    if (status.includes('Follow')) return 'text-green-600 bg-green-50';
    if (status.includes('Planning')) return 'text-yellow-600 bg-yellow-50';
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredPatients.map((patient) => (
                <tr key={patient.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{patient.stage}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="text-sm font-medium text-gray-900 mr-2">{patient.adherence}%</div>
